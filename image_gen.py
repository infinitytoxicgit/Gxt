...
def make_puzzle_image(jumbled, mode_tag, puzzle_id):
    ...
    # Header Card Top Badge
    header_font = get_font(44, bold=True)
    draw.text((width // 2, 75), "🧩 𝐉𝐔𝐌𝐁𝐋𝐄 𝐖𝐎𝐑𝐃 𝐆𝐀𝐌𝐄", anchor="mm", font=header_font, fill=(255, 255, 255))

    # Inner Word Glowing Container
    draw.rounded_rectangle([(90, 150), (width - 90, 420)], radius=24, fill=(22, 28, 44, 255), outline=(0, 255, 180, 180), width=2)

    # Dynamic Letter Spacing & Font Scaling
...
# 2. SMART STATS PERFORMANCE GRAPH
...
def make_leaderboard_graph_image(scope_title: str, timeframe: str, top_data: list):
    ...
    draw.text((w // 2, 60), f"🏆 {scope_title.upper()}", font=get_font(34, bold=True), fill=(255, 255, 255), anchor="mm")
